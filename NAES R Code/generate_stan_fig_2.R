...
generate_fig_2_for_2008 <- function(data_matrix, dat.stt, dat.vot, plot_title_file = "2008_stan_fig2.png", source = "June-Nov Pew surveys")
{
  ...
  mtext_line2 <- paste(" Dots are weighted averages from pooled ", source, "; error bars show +/- 1 s.e. bounds.\n Curves are estimated using multilevel models and have a s.e. of about 3% at each point.\n States are ordered in decreasing order of McCain vote (Alaska, Hawaii, and D.C. excluded).", sep = "")   
